...
# 在 synthetic SCM 上比较 baseline / oracle / shuffled / corr 注入。
...
DATA_PATH="${DATA_PATH:-}"
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/outputs/oracle_mb}"
SEED="${SEED:-42}"
DEVICE="${DEVICE:-cpu}"
...
for SOURCE in oracle shuffled corr; do
